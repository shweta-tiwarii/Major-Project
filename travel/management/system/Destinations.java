...
public class Destinations extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Orientel Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel","Classio Hotel", "The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy morning Hotel","River View Hotel"};
        try {
            for(int i=0;i<9;i++){
    ...
    Destinations(){
       ...
       for (int i=0 ; i<9 ; i++) {
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/Destin"+(i+1)+".jpg"));
